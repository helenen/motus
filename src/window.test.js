...
describe('Grid writer', function () {
  test('should write the grid on the page', () => {
    ...
    let expected = JSDOM.fragment('<div id="grid">'
          + '<div id="turn0">'
            + '<input type="text" maxlength="1" class="slot0" value="t" required>'
            + '<input type="text" maxlength="1" class="slot1" value=""> required'
            + '<input type="text" maxlength="1" class="slot2" value="" required>'
            + '<input type="text" maxlength="1" class="slot3" value="" required>'
            + '<input type="text" maxlength="1" class="slot4" value="" required>'
            + '<input type="text" maxlength="1" class="slot5" value="" required>'
            + '<input type="text" maxlength="1" class="slot6" value="" required>'
  ...
  test('should write down history correctly', () => {
    ...
    let expected = JSDOM.fragment('<div id="grid">'
          ...
          + '</div>'
          + '<div id="turn2">'
            + '<input type="text" maxlength="1" class="slot0" value="a" required>'
            + '<input type="text" maxlength="1" class="slot1" value="" required>'
            + '<input type="text" maxlength="1" class="slot2" value="e" required>'
            + '<input type="text" maxlength="1" class="slot3" value="" required>'
            + '<input type="text" maxlength="1" class="slot4" value="t" required>'
            + '<input type="text" maxlength="1" class="slot5" value="y" required>'
            + '<input type="button" value="Jouer" id="submit" class="submit">'
          + '</div>'
          + '<div id="turn3">'
            + '<input type="text" maxlength="1" class="slot0" value="" disabled>'
  ...
  test('should indicate if a character is in the wrong place', () => {
    ...
    let expected = JSDOM.fragment('<div id="grid">'
          ...
          + '<div id="turn1">'
            + '<input type="text" maxlength="1" class="slot0" value="a" required>'
            + '<input type="text" maxlength="1" class="slot1" value="z" required>'
            + '<input type="text" maxlength="1" class="slot2" value="" required>'
            + '<input type="text" maxlength="1" class="slot3" value="" required>'
            + '<input type="text" maxlength="1" class="slot4" value="" required>'
            + '<input type="text" maxlength="1" class="slot5" value="" required>'
  ...
  test('should return the submitted word', () => {
    let dom = JSDOM.fragment('<div id="grid">'
      ...
      + '<div id="turn2">'
        ...
        + '<input type="text" maxlength="1" class="slot1" value="z" required>'
        + '<input type="text" maxlength="1" class="slot2" value="e" required>'
        + '<input type="text" maxlength="1" class="slot3" value="r" required>'
        + '<input type="text" maxlength="1" class="slot4" value="t" required>'
        + '<input type="text" maxlength="1" class="slot5" value="y" required>'
        + '<input type="button" value="Jouer" id="submit" class="submit">'
      + '</div>'
